...
- Lots of tests! This is our first app (out of 8 apps in 6 years) with
  ...
  - Our other apps are not super involved in the front end.  As such,
    they have relatively small amounts of browser-side code. As a result, vanilla
    ...
    tests, going all the way back with [[http://thinkrelevance.com/blog/2009/05/12/blue-ridge-1-0-javascript-unit-testing-for-rails-scandalous][blueridge]] and then
    newer approaches.  Keeping test  momentum
    going was hard, but since these apps didn't have much front-end functionality,
    we could live with the unsatisfactory results.
  - All that changed with this app which has complex business rules
