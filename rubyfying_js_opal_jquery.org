...
it has never dawned on me that I would do a =Element.ready?=; I would always apply this to =Document=.*
...
article, we'll show you even more techniques by exploring the Opal library code that wraps jQuery's API.
